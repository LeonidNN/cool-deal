...
export default function AirPage() {
  const d = DEVICES.find(v => v.slug === "air")!;
  return (
    <main className="bg-gradient-to-b from-[color:var(--bg-top)] to-[color:var(--bg-bottom)]">
      <Section title={d.title} subtitle="Мощный модуль с жилетом. Питание 12В DC. Диапазон 18–30°C, режим нагрева. Мощность 300 Вт, охлаждение до 600 Вт.">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="card p-6 sm:p-8">
            ...
            <ul className="mt-3 space-y-2 text-[color:var(--muted)]">
              <li>• Литейные/стекольные производства</li>
              <li>• Теплицы и агрокомплексы</li>
              <li>• Складская логистика</li>
              <li>• Длительная работа в жаре</li>
            </ul>
          </div>
        </div>
      </Section>
